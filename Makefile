...
parsing/5_field_spliting.c parsing/6_tokenize.c parsing/7_parsing.c parsing/8_parsing.c parsing/9_remove_quotes.c \
...
execution/bin_export.c execution/bin_env.c execution/bin_echo.c execution/execution.c \
