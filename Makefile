...
parsing/5_field_spliting.c parsing/6_tokenize.c parsing/7_parsing.c parsing/8_parsing.c parsing/9_check_files.c parsing/10_remove_quotes.c parsing/11_handling_null.c parsing/5.1_export_field.c \
parsing/12_shlvl_pwdreset.c \
tools/tool0.c tools/tool1.c tools/tool2.c tools/tool3.c tools/tool4.c tools/tool5.c tools/tool6.c tools/tool7.c tools/tool8.c \
execution/redirection_n_files.c execution/1_handle_heredoc.c execution/2_handle_herdoc.c execution/get_cmd_dir.c execution/bin_pwd.c execution/bin_cd.c execution/bin_unset.c \
